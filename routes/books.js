...
/** 
 @api {post} /library/books  Create the single book
 * @apiName postBooks
 * @apiGroup books
 *
...
/** 
 @api {get} /library/books get all the books
 * @apiName getAllBooks
 * @apiGroup books
 *
 * @apiSuccess {String} Bookname get the Bookname
...
router.get('/books', async function (req, res) {
 ...
 /** 
 @api {get} /library/books/:authorid get the author by id
...
/** 
 @api {put} /library/books/:id  update the existing book by id
 * @apiName putBook
 * @apiGroup books
 *
...
/** 
 @api {delete} /library/books/:id  delete the existing book by id
 * @apiName deleteBook
 * @apiGroup books
 * 
